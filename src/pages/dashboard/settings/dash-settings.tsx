...
export default function DashSettingsPage() {
  ...
  useEffect(()=>{
    if(companyInfo === null){
      axios.get(`${api}/settings/companyinfo`)
  ...
  return (
    <DashboardLayout>
      <div className="w-full p-5 flex flex-col min-h-[60vh]">
        <h1>Manage Settings</h1>
        <Divider />
        <div className="w-full flex justify-between ">
          <div className="w-full flex flex-col gap-5 h-[50vh] p-5 overflow-y-scroll">
            <h1>Company Info</h1>
...
function CompanyLogoUi({company}:{company:CompanyInfo | null}) {
  ...
  return (
    <div className="flex flex-col items-center rounded-xl p-5 h-[70%] gap-5">
      <div>
